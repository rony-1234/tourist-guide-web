...
const Featuretab = () => {
  ...
  <TabPanel className='text-center'>
     <h2 className='text-sm my-8 p-4'>VistaVoyages websites are like digital compasses, guiding adventurers through the vast landscapes of the world wide web. They're a one-stop-shop for wanderlust, offering a treasure trove of information to turn any journey into a grand adventure. From the peaks of destination guides to the valleys of travel tips, these websites weave a tapestry of exploration. Accommodation becomes a cozy corner, activities and attractions unfold like a map, and dining experiences are a feast for the senses.</h2>
     <iframe className='w-full h-60 aspect-video hover:aspect-auto' src="https://www.youtube.com/embed/Hfoi76YbnzA?si=tYk7vjs_FOHwvHvW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; 
  ...
  <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		<p className="p-2 text-sm font-medium tracki text-center uppercase">Our Team</p>
		<h1 className="text-2xl font-bold leadi text-center sm:text-xl">We have a team of professionals, dedicated to providing excellent service to ensure the enjoyment of your vacation.</h1>
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Roberto Carlos</p>
					<p>Marketing</p>
				</div>
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading">Mitchel Santer</p>
					<p>Tour Operator</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Marry Putter</p>
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Ricardo Kaka</p>
					<p>Tour Specalist</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Tom Matt</p>
					<p>Tour Guidline</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
			...
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
				...
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leadi">Henry Philips</p>
					<p>Visualzing</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
