...
const Login = () => {
    ...
    return (
		<div className="flex items-center justify-between my-8 px-8 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ">
			<div>
				<img className="w-80 h-70 rounded" src="https://i.ibb.co/JCSLDgs/67676767.png"/>
			</div>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
		...
		<Link to='/register'>
		<button rel="noopener noreferrer" type="submit" href="#" className="underline dark:text-gray-100"></button>
		</Link>
